...
const contentForS1 = 'I have built a catalogue, that is, a browsable list of items that you can filter and access to the details of one item. All data are meals recipes that come from TheMealDb API';
...
const GitHublinkForS3 = 'https://github.com/IBUNHABIBU/catalogue_of_recipes';
